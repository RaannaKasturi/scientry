    ...
    return (
        <section id="features" className="bg-secondary py-16 flex flex-col items-center">
            ...
            <div className="mx-5 md:mx-36 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group group">
                    <div>
                        ...
                        <p>Our <b>Scientry's Paper Fetcher</b> can fetch almost any research paper for you. Just give us the DOI URL or ID of the paper and we will fetch it for you.</p>

                    </div>
                    <Button variant={'outline'} className="bg-transparent border rounded-full w-fit hover:scale-105 transition-all duration-300 border-secondary-foreground group hover:border-primary hover:bg-secondary hover:text-primary mt-5">Fetch Papers <ChevronRightIcon className="group-hover:hidden flex" /> <ChevronsRightIcon className="group-hover:flex hidden" />  </Button>
                </div>
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group">
                    <div>
                        ...
                        < Separator orientation="horizontal" className="mt-2 mb-3 bg-primary w-3/5 group-hover:w-full transition-all duration-700" />
                        <p>Our <b>Scientry's Citation Generator</b> can generate citation of any research paper with a valid DOI ID or URL in seconds. It can generate citations in not one or two formats but in over than over a 100 different formats.</p>
                    </div>
                ...
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group">
                    <div>
                        ...
                        < Separator orientation="horizontal" className="mt-2 mb-3 bg-primary w-3/5 group-hover:w-full transition-all duration-700" />
                        <p>Our <b>Scientry's Summary Generator</b> can generate summary of any research paper with a valid DOI ID or URL in seconds no matter the length of the research paper. It can accurate and well-formatted summaries of research papers.</p>
                    </div>
                ...
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group">
                    <div>
                        ...
                        < Separator orientation="horizontal" className="mt-2 mb-3 bg-primary w-3/5 group-hover:w-full transition-all duration-700" />
                        <p>Our <b>Scientry's Mindmap Generator</b> has the ability to generate accurate and precise mindmaps of any research paper with a valid DOI ID or URL in seconds.</p>
                    </div>
                ...
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group">
                    <div>
                        ...
                        < Separator orientation="horizontal" className="mt-2 mb-3 bg-primary w-3/5 group-hover:w-full transition-all duration-700" />
                        <p>Our <b>Scientry's Research Bulletin</b> provides key insights of the latest research across the globe at one place without any hustle to keep you updated on the go.</p>
                    </div>
                ...
                <div className="flex flex-col justify-between hover:scale-105 duration-300 bg-secondary-foreground/10 p-5 rounded-lg group">
                    <div>
                        ...
                        < Separator orientation="horizontal" className="mt-2 mb-3 bg-primary w-3/5 group-hover:w-full transition-all duration-700" />
                        <p>We at <b>Scientry</b> are ready to help you with all your research needs. Need a specialized tool for your research or suggest a feature to us  or just a feedback of your service. We welcome you.</p>
                    </div>
